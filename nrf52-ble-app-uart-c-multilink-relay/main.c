    ...
    switch (p_event->evt_type)
    {
        ...
        case APP_UART_DATA_READY:
                ...
                (index >= (m_ble_nus_max_data_len)))
            {
                ...
                //}
                app_nus_client_send_data(data_array,index);//central component of Relay  send data to PERIPHERAL devices
...
void bsp_event_handler(bsp_event_t event)
{
    ...
    switch (event)
    {
        ...
        case BSP_EVENT_DISCONNECT://case nay o vi du relay thay no khong lam gi
            //for(int c = 0; c < NRF_SDH_BLE_CENTRAL_LINK_COUNT; c++)
            //{
...
int main(void)
{
    ...
    printf("BLE UART central multilink relay started.\r\n");
    NRF_LOG_INFO("BLE UART central multilink relay started\r\n.");
    // Enter main loop.
    for (;;)
    {
        idle_state_handle();
